...
class EnumModelReadOnlyView(BaseForEnumModel, generics.ListAPIView, generics.RetrieveAPIView):
    pass


class EnumModelReadOnlyViewSet(BaseForEnumModel, viewsets.ReadOnlyModelViewSet):
    pass
